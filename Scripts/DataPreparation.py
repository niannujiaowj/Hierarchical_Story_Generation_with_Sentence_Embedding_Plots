...
def Plots(in_file_story, in_file_sensplit, out_file_name):
    ...
    with open(in_file_sensplit, "r") as f1:
        SenSplitting = json.load(f1)[186090:186091]
    ...
    with open(in_file_story,"r") as f:
        for n_story, story in tqdm(enumerate(f.readlines()[186090:186091])):
            try:
                # SRL
...
if __name__ == '__main__':
    Plots("Dataset/WritingPrompts/train.wp_target", "Dataset/SenSplitting/train_target_sensplit.json", "train_186090_186091")
