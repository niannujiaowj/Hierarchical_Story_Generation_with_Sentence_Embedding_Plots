...
if __name__ == '__main__':
    ...
    parser.add_argument('--TRAIN_SRC', type=str, default="Dataset/Plots/train")
    parser.add_argument('--TRAIN_TGT', type=str, default="Dataset/WritingPrompts/train.wp_target")
    parser.add_argument('--VALID_SRC', type=str, default="Dataset/Plots/valid")
    parser.add_argument('--VALID_TGT', type=str, default="Dataset/WritingPrompts/valid.wp_target")
    parser.add_argument('--TEST_SRC', type=str, default="Dataset/Plots/test")
    ...
    parser.add_argument('--SOURCE_MAX_TOKEN_LEN', type=int, default=500)
    ...
    if MODE == 'Train':
        ...
        checkpoint_callback = ModelCheckpoint(dirpath = CHECKPOINTS_SAVE_PATH,
                                              filename = 'Baseline_2_best_checkpoint_{epoch:02d}_{val_loss:.2f}',
        ...
        Generate_Story.generate_story(test_dataloader, INFERENCE_SAVE_PATH + "Baseline_2_" + str(today) + ".txt")